...
var unoneu;
(function (unoneu) {
    document.addEventListener("DOMContentLoaded", UnoCode);
    let karte0 = {
        color: "red",
        value: "0",
    };
    ...
    function UnoCode() {
        ...
        for (let i = 0; i < anzahlKarten; i++) {
            ...
            let xcard = allCards.splice(randomCardnumber, 1)[0];
    ...
    function initEventListener() {
        let placeOrRemoveCard = document.getElementById("nachziehstapel");
    ...
    function itemsSort(card1, card2) {
    ...
    function addingCardtoHand() {
        eraseCards();
        for (let i = 0; i < 1; i++) {
            let randomNumber = random(allCards.length);
            let xcard2 = allCards.splice(randomNumber, 1)[0];
    ...
    function removeCardfromHand(_event) {
        let eventCards = document.getElementById("content");
        let documentObjectModelCard = _event.target;
        if (documentObjectModelCard != eventCards) {
            let a;
            let documentObjectModelAttribute = documentObjectModelCard.getAttribute("id");
            documentObjectModelAttribute = documentObjectModelAttribute.substr(1);
            a = parseInt(documentObjectModelAttribute);
            let xcard3 = otherCards.splice(a, 1)[0];
    ...
    function placeDiv1(_color, _x, _n) {
    ...
    function placeDiv2(_color, _x, _n) {
        let div = document.createElement("div");
