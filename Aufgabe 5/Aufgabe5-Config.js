...
(function (aufgabe5) {
    ...
    function fillFieldset() {
        ...
        for (let i = 0; i < aufgabe5.christmasBulb.length; i++) {
            childHTML += "<option value=";
            childHTML += "christmasBulb1" + i;
            childHTML += ">";
            childHTML += aufgabe5.christmasBulb[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        for (let i = 0; i < aufgabe5.candle.length; i++) {
            ...
            childHTML += "candle1" + i;
            childHTML += ">";
            childHTML += aufgabe5.candle[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        for (let i = 0; i < aufgabe5.lametta.length; i++) {
            ...
            childHTML += ">";
            childHTML += aufgabe5.lametta[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=clear selected></option>";
        for (let i = 0; i < aufgabe5.treeTyp.length; i++) {
            childHTML += "<option value=";
            childHTML += "tree" + i;
            childHTML += ">";
            childHTML += aufgabe5.treeTyp[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        for (let i = 0; i < aufgabe5.holder.length; i++) {
            ...
            childHTML += "halter" + i;
            childHTML += ">";
            childHTML += aufgabe5.holder[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        for (let i = 0; i < aufgabe5.shipment.length; i++) {
            ...
            childHTML += "versand" + i;
            childHTML += ">";
            childHTML += aufgabe5.shipment[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
    ...
    function handleChange(_event) {
        ...
        if (target.id == "christmasBulb1") {
            ...
            let childHTML = aufgabe5.christmasBulb[index].name;
            christmasBulbPrice = aufgabe5.christmasBulb[index].price;
        ...
        if (target.id == "christmasBulb2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.christmasBulb[index].name;
            christmasBulbPrice2 = aufgabe5.christmasBulb[index].price;
        ...
        if (target.id == "christmasBulb3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.christmasBulb[index].name;
            christmasBulbPrice3 = aufgabe5.christmasBulb[index].price;
        ...
        if (target.id == "candle1") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.candle[index].name;
            candlePrice = aufgabe5.candle[index].price;
        ...
        if (target.id == "candle2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.candle[index].name;
            candlePrice2 = aufgabe5.candle[index].price;
        ...
        if (target.id == "candle3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.candle[index].name;
            candlePrice3 = aufgabe5.candle[index].price;
        ...
        if (target.id == "lametta1") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.lametta[index].name;
            lamettaPrice = aufgabe5.lametta[index].price;
        ...
        if (target.id == "lametta2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.lametta[index].name;
            lamettaPrice2 = aufgabe5.lametta[index].price;
        ...
        if (target.id == "lametta3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.lametta[index].name;
            lamettaPrice3 = aufgabe5.lametta[index].price;
        ...
        if (target.id == "tree") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.treeTyp[index].name;
            treePrice = aufgabe5.treeTyp[index].price;
        ...
        if (target.id == "holder") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5.holder[index].name;
            holderPrice = aufgabe5.holder[index].price;
        ...
        if (target.id == "shipment") {
            let convertedString = target.value.substr(7);
            let index = Number(convertedString);
            let childHTML = aufgabe5.shipment[index].name;
            shipmentPrice = aufgabe5.shipment[index].price;
...
//# sourceMappingURL=Aufgabe5-Config.js.map