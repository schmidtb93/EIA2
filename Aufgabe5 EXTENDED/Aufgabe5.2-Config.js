var aufgabe5extended;
(function (aufgabe5extended) {
    ...
    function fillFieldset() {
        ...
        for (let i = 0; i < aufgabe5extended.christmasBulb.length; i++) {
            childHTML += "<option value=";
            childHTML += "christmasBulb1" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.christmasBulb[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=0 selected></option>";
        for (let i = 0; i < aufgabe5extended.candle.length; i++) {
            childHTML += "<option value=";
            childHTML += "candle1" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.candle[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=0 selected></option>";
        for (let i = 0; i < aufgabe5extended.lametta.length; i++) {
            childHTML += "<option value=";
            childHTML += "lametta1" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.lametta[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=clear selected></option>";
        for (let i = 0; i < aufgabe5extended.treeTyp.length; i++) {
            childHTML += "<option value=";
            childHTML += "tree" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.treeTyp[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=clear selected></option>";
        for (let i = 0; i < aufgabe5extended.holder.length; i++) {
            childHTML += "<option value=";
            childHTML += "halter" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.holder[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
        ...
        childHTML += "<option value=clear selected></option>";
        for (let i = 0; i < aufgabe5extended.shipment.length; i++) {
            childHTML += "<option value=";
            childHTML += "versand" + i;
            childHTML += ">";
            childHTML += aufgabe5extended.shipment[i].name;
            childHTML += "</option>";
        }
        childHTML += "</select>";
    ...
    function handleChange(_event) {
        ...
        if (target.id == "christmasBulb1") {
            ...
            let childHTML = aufgabe5extended.christmasBulb[index].name;
            christmasBulbPrice = aufgabe5extended.christmasBulb[index].price;
        ...
        if (target.id == "christmasBulb2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.christmasBulb[index].name;
            christmasBulbPrice2 = aufgabe5extended.christmasBulb[index].price;
        ...
        if (target.id == "christmasBulb3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.christmasBulb[index].name;
            christmasBulbPrice3 = aufgabe5extended.christmasBulb[index].price;
        ...
        if (target.id == "candle1") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.candle[index].name;
            candlePrice = aufgabe5extended.candle[index].price;
        ...
        if (target.id == "candle2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.candle[index].name;
            candlePrice2 = aufgabe5extended.candle[index].price;
        ...
        if (target.id == "candle3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.candle[index].name;
            candlePrice3 = aufgabe5extended.candle[index].price;
        ...
        if (target.id == "lametta1") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.lametta[index].name;
            lamettaPrice = aufgabe5extended.lametta[index].price;
        ...
        if (target.id == "lametta2") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.lametta[index].name;
            lamettaPrice2 = aufgabe5extended.lametta[index].price;
        ...
        if (target.id == "lametta3") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.lametta[index].name;
            lamettaPrice3 = aufgabe5extended.lametta[index].price;
        ...
        if (target.id == "tree") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.treeTyp[index].name;
            treePrice = aufgabe5extended.treeTyp[index].price;
        ...
        if (target.id == "holder") {
            ...
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.holder[index].name;
            holderPrice = aufgabe5extended.holder[index].price;
        ...
        if (target.id == "shipment") {
            let convertedString = target.value.substr(7);
            let index = Number(convertedString);
            let childHTML = aufgabe5extended.shipment[index].name;
            shipmentPrice = aufgabe5extended.shipment[index].price;
...
})(aufgabe5extended || (aufgabe5extended = {}));
//# sourceMappingURL=Aufgabe5.2-Config.js.map